  ...
  return (
    ...
    <>
      ...
      <div className='w-full'>
        <div className='m-auto  mb-12  flex items-center justify-center gap-6'>
          <input onChange={(e) => search(e)} type="text" className='border-border md:w-[500px] text-text  border-[1px] border-dashed px-7 py-5 rounded-[40px] text-[20px] focus:outline-none bg-main' placeholder='Project (Name or Code)' />
          <p className='text-text text-[20px] hidden md:block font-bold '>Search</p>
        </div>
      </div>
      <div className='mb-5 bg-bg text-[20px] border-[3px] w-[80%] m-auto p-5 border-border  rounded-lg text-text'>

        <div className='flex items-center justify-between w-full '>
          <p className='p-5  text-[25px] font-semibold text-text'><span className='text-[#f5f0cb] md:ms-[90px] text-[30px]'>Projects</span></p>
        </div>
